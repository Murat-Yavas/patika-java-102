...
public class Notebook extends Product{
    public Notebook(String uniqueID, int unitPrice, double discountRate, int amountOfStock, String name, String brandName, int memory, double sizeOfScreen, int battery, int ram, String color, int camera){
